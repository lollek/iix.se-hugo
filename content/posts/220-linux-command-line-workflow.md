...
Z is a tool for easily changing your working directory. If you ever `cd` to a location it will be remembered, and afterwards you can `cd` back with a fuzzy query.
E.g. if you have a folder called ~/github, you can go to it by typing `z git` or `z hub`. 
